...
SCORELESS_TOOLS = {
    ...
    "WebSearch",
    "scrapling_stealth",
    # Primary evidence generated by the run itself — behaviour executed, source
    # read, local filesystem inspected. Carries no Tavily score by construction:
    # it never passed through a retrieval engine. Canonicalized by
    # methodology.md §6 "Software-capability sources" (2026-08-13), which grades
    # it Tier 1 and requires the verification be described in `notes`.
    "direct_observation",
}
