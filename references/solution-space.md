...
| `open-source` | Repositories and packages implementing the capability | [github-research.md](github-research.md) — star-band sharding, composite ranking, fake-star gate. Reuse it; do not restate its mechanics here |
...
| `open-source` | "&lt;capability&gt; client library", "&lt;protocol&gt; SDK", "self-hosted &lt;capability&gt; bridge", "CLI for &lt;capability&gt;" | "&lt;platform&gt; scraper github" |
